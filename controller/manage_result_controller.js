var manage_result = require('../model/add_result_model');
...
exports.delete_data = async (req,res) => {
  ...
  var data = await manage_result.findByIdAndDelete(id);
...
req.body.result = result;
  ...
  var data = await manage_result.findByIdAndUpdate(id,req.body);
